...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        input[type="text"], input[type="password"], input[type="file"] { width: 100%; padding: 10px; margin: 6px 0 14px 0; box-sizing: border-box; border: 1px solid #475569; border-radius: 4px; background: #0f172a; color: #fff; }
        ...
        <div class="grid-layout">
            <div>
                <div class="box">
                    ...
                    <div class="cam-segment">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <span style="font-size:14px; font-weight:bold; color:#f8fafc;">📷 Camera Scanner</span>
                            <div>
                ...
                <div class="box">
                    ...
                    <div id="upload-status" style="margin-top: 10px; color: #94a3b8; font-size: 13px; text-align: center;"></div>
                </div>
        ...
        if (secret) {
            try {
                ...
                if (secret.length >= 16) {
                    ...
                    uploadStatus.textContent = "Success! Adding token...";
                } else {
                    uploadStatus.textContent = "Secret too short. Please use Option 3.";
                }
            } catch (err) { 
